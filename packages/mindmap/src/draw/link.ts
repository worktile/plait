...
export function drawLink(
    ...
    let beginX,
        ...
        beginNode = node,
        endNode = child;
    const layout = MindmapQueries.getCorrectLayoutByElement(board, node.origin) as MindmapLayoutType;
    if (isHorizontal) {
    ...
    const stroke = defaultStroke || getLinkLineColorByMindmapElement(board, child.origin);
