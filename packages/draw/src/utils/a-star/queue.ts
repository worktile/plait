...
export class PriorityQueue<T, K> {
    ...
    bubbleDown(): void {
        ...
        for (;;) {
            ...
            let swap = -1;
            let leftChild: PriorityQueueNode<T, K>, rightChild: PriorityQueueNode<T, K>;
            ...
            if (rightChildIndex < length) {
                ...
                if (
                    (swap === null && this._compare(rightChild.priority, element.priority) < 0) ||
                    (swap !== null && this._compare(rightChild.priority, leftChild.priority) < 0)
                ) {
