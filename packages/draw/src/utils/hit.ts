import { PlaitElement, RectangleClient, Range, PlaitBoard, isPolylineHitRectangle, Point } from "@plait/core";
...
export const isRectangleHitDrawElement = (board: PlaitBoard, element: PlaitElement, range: Range) => {
